...
steps:
  ...
  lipid-lowering-agents-200microgram---primary:
    run: lipid-lowering-agents-200microgram---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  lipid-lowering-agents-400mg---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: lipid-lowering-agents-200microgram---primary/output
  ...
  lipid-lowering-agents-267mg---primary:
    run: lipid-lowering-agents-267mg---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  lipid-lowering-agents-rosuvastatin---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: lipid-lowering-agents-267mg---primary/output
